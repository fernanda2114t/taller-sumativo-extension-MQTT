...
try:
    while True:
        valor = round(random.uniform(30.0, 180.0), 2)
        mensaje = json.dumps({"sensor": "toneladas", "valor": valor, "grupo": "zona_perforacion", "publish_time": time.time()})
