...
try:
    while True:
        valor = round(random.uniform(25.0, 300.0), 2)
        mensaje = json.dumps({"sensor": "particulado", "valor": valor, "grupo": "zona_perforacion", "publish_time": time.time()})
